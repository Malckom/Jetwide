<?php
// Simple, clean contact form handler - TEST VERSION
...
<head>
    ...
    <style>
        ...
        .section { margin-bottom: 20px; padding: 15px; border-left: 3px solid #d4af37; background: #f9f9f9; }
...
<body>
    ...
    return $return . "<div class='section'>
